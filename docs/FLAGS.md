...
| `saw_lookout` | F08 展望所から町の光を数えた（無いはずの光） | 8/16 以降 F08 | 展望所の怪異の条件、Act 2 の目的地の示し方 |
| `f09_reached_keep` | F09 主郭の礎石を調べた | F09 | 土橋が消える怪異の条件 |
| `f09_bridge_gone` | F09 の土橋が消え、隠し口が開いた | 怪異 `an_f09_bridge_gone` | F09 の配置（崖と獣道） |
...
- 時間経過では上がらない（タスク10 で 0 に。以前は +1／+2 で、どの経路でも 8/21 までに 100 に達していた）。
