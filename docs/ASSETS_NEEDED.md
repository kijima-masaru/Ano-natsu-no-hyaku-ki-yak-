...
| 縮尺 | **1 マス（32 px）≈ 1.7 m ＝ 人の身長**。人物は 32×48 の枠の下 32 px に収める（追跡者だけ 36 px）。物の大きさは現実の比率に合わせる：木 3〜4 マス高（幅 3）、街灯 3、電柱 5、塔 5〜6、鳥居・山門 3（幅 3）、駐車車両 1×2、自販機・電話ボックス・扉・塀は 1 マス。壁は地図の行数で高さが決まる（1 行 ≈ 1.7 m） |
